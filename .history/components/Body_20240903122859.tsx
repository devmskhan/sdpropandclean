...
function Body() {
  ...
  <img src="stairsaft.jpg" alt="Bottom Image" className="mt-28 ml-20 absolute bottom-0 left-0 w-64 h-64 rounded-lg shadow-lg transform translate-x-4 translate-y-4 border-gray-500 border-solid border-4" />
  </div>
</div>
