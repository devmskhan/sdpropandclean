...
<div className="flex flex-col items-center">
  <img src=".jpg" alt="Top Image" className="mt-5 w-64 h-64 rounded-lg shadow-lg border-gray-500 border-solid border-4" />
  <span className="mt-2 text-gray-700 font-medium">Before</span>
</div>
<div className="flex flex-col items-center">
  <img src="tltaft tltbf.jpg" alt="Bottom Image" className="mt-5 w-64 h-64 rounded-lg shadow-lg border-gray-500 border-solid border-4" />
  <span className="mt-2 text-gray-700 font-medium">After</span>
</div>
</div>
<div className="max-w-md text-left mr-12"> {/* Increased margin-right for larger space */}
