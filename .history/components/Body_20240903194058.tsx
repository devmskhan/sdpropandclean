...
{/* About Us Section */}
<section className="flex justify-between bg-white p-8 rounded-lg shadow-md">
...
<section className="bg-white p-8 rounded-lg shadow-md">
  ...
  <img src="/wmncln.jpg" alt="Managing Director" className="w-48 h-48 rounded-full shadow-lg" />
</section>
  ...
  <div className="mt-6 space-y-4">
    ...
    <div className="flex flex-col space-y-4">
      <div className="flex items-start space-x-4">
        ...
        <img src="/mncln.jpg" alt="Managing Director" className="w-64 h-64 shadow-lg" />
      </div>
      <div className="flex items-start space-x-4">
...
<section className="bg-white p-8 rounded-lg shadow-md">
  ...
  <div className="w-full h-64">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3914.764220131597!2d8.540716074655907!3d12.00500163932969!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x11ae8218653a5dbd%3A0xfdd64e485c3089cf!2sZoo%20Rd%2C%20Kano%2C%20Nigeria!5e0!3m2!1sen!2sng!4v1693763085957!5m2!1sen!2sng"
      width="100%"
      height="100%"
      loading="lazy"
    ></iframe>
...
<section className="bg-white p-8 rounded-lg shadow-md">
  ...
  <div className="text-center space-y-4">
    ...
    <p className="text-lg text-gray-700">
      <strong>Phone:</strong> +234-7032187241
    </p>
...
<div className="container mx-auto px-4">
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    {/* Company Details */}
    <div>
      <h3 className="text-lg font-semibold mb-4">SD Properties & Cleaning Services</h3>
      <p>
        We provide top-notch property development and cleaning services, ensuring your space is always in its best shape.
      </p>
      <p className="mt-4">&copy; 2024 SD Properties & Cleaning Services. All rights reserved.</p>
    </div>
    ...
    <div>
      ...
      <ul>
        <li className="mb-2"><a href="#home" className="hover:text-gray-200">Home</a></li>
        <li className="mb-2"><a href="#about" className="hover:text-gray-200">About Us</a></li>
        <li className="mb-2"><a href="#services" className="hover:text-gray-200">Our Services</a></li>
        <li className="mb-2"><a href="#contact" className="hover:text-gray-200">Contact Us</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <p className="mb-2">Block F81 Kundila,Zoo Road,Kano State, Nigeria</p>
      <p className="mb-2">Phone: +234-7032187241</p>
      <p className="mb-2">Email: info@sdcleaningservices.com</p>

      {/* Social Media Links */}
      <div className="flex mt-4 space-x-4">
        <a href="https://facebook.com" className="hover:text-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
            <path d="M22.675 0h-21.35c-..."></path> {/* Facebook Icon SVG */}
          </svg>
        </a>
        <a href="https://twitter.com" className="hover:text-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
            <path d="M23.954 4.569c-..."></path> {/* Twitter Icon SVG */}
          </svg>
        </a>
        <a href="https://instagram.com" className="hover:text-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
            <path d="M12 0c-..."></path> {/* Instagram Icon SVG */}
          </svg>
        </a>
      </div>
    </div>
