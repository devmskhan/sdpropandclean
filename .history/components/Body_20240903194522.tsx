...
<section className="bg-white p-8 rounded-lg shadow-md">
  ...
  <img src="/mncln.jpg" alt="Managing Director" className="w-48 h-48 rounded-full shadow-lg" />
  </div>
...
<section className="bg-white p-8 rounded-lg shadow-md">
  ...
  <img src="/wmncln.jpg" alt="Managing Director" className="w-64 h-64 shadow-lg" />
</section>
