  ...
  <div className="flex flex-col lg:flex-row items-center mt-6 space-y-6 lg:space-y-0 lg:space-x-12">
    ...
    <div className="text-center lg:text-left">
      ...
      <p className="mt-4 text-gray-700">
        With over  of experience in property development and cleaning services, John Doe has been instrumental in driving the growth of SD Properties & Cleaning Services. His expertise and leadership ensure that our clients receive the highest standards of service and care.
      </p>
    </div>
  </div>
</section>
