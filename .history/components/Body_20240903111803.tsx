...
function Body() {
  ...
  <div className="relative mt-6">
    <img src="top-image.jpg" alt="Top Image" className="w-64 h-64 rounded-lg shadow-lg" />
    <img src="bottom-image.jpg" alt="Bottom Image" className="absolute bottom-0 left-0 w-32 h-32 rounded-lg shadow-lg transform translate-x-4 translate-y-4" />
  </div>
</div>
