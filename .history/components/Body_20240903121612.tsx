...
function Body() {
  ...
  <div className="max-w-md text-left mr-12"> {/* Increased margin-right for larger space */}
    <p className="text-lg font-medium text-gray-700 mt-4 ml-5">
  ...
  <div className="relative">
    <img 
      src="stairsb.jpg" 
      alt="Top Image" 
      className="w-64 h-64 rounded-lg shadow-lg border-gray-500 border-solid border-4 transform rotate-6" 
      style={{ zIndex: 10 }} // Adds a bit of depth to the rotation 
    />
    <img 
      src="stairsaft.jpg" 
      alt="Bottom Image" 
      className="absolute bottom-0 left-0 w-64 h-64 rounded-lg shadow-lg border-gray-500 border-solid border-4 transform translate-x-6 translate-y-6" 
    />
  </div>
</div>
