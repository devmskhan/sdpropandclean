...
function Body() {
  ...
  <div className="relative mt-6">
    ...
    <img src="stairsaft.jpg" alt="Bottom Image" className="absolute bottom-0 left-0 w-64 h-64 rounded-lg shadow-lg transform translate-x-4 translate-y-4 ml-5 border border-col" />
  </div>
</div>
